...
<h2 class="sub-header">Projects for {{ $activeSemester->Name }} <a href="/admin/projects/new" class="btn btn-default">New</a>  <a href="{{ URL::route('admin.projects.uploadCognos', $activeSemester->id) }}" class="btn btn-default">Upload a Cognos Report</a>
    <a href="{{ URL::route('admin.projects.reports', $activeSemester->id) }}" class="btn btn-default">Reports</a></h2>
