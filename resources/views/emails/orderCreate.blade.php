...
@section('content')
    ...
    <p>Your order has been received! Orders are generally processed within 24-48 hours. We will email you again once
        items from your order have been purchased or if we have any questions regarding your order. Keep in mind this
        email is a confirmation that we received your submission, we will email you once again once the items have been
        physically purchased.</p>
