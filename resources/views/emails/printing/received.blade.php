...
@section('content')
    ...
    <p>You will receive an email to come pick up the print from the Idea Shop once your poster has been printed. We will supply you with foam core and spray glue to mount your poster. </p>
