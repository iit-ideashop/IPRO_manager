...
@section('content')
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        @if($item->Returning)
                                            <li><a href="/admin/items/{{$item->id}}/markNotReturning">Mark Not
                                                    Returning</a></li>
                                        @else
                                            <li><a href="/admin/items/{{$item->id}}/markReturning">Mark Returning</a>
                                            </li>
                                        @endif
    ...
    <!-- MODALS!!! -->
    @foreach($items as $item)
        <div class="modal fade" id="edit{{$item->id}}Modal" tabindex="-1" role="dialog"
        ...
        <div class="modal fade" id="{{$item->id}}DeleteModal" tabindex="-1" role="dialog"
             aria-labelledby="{{$item->id}}DeleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
    ...
    <div class="modal fade" id="massStatusModal" tabindex="-1" role="dialog" aria-labelledby="massStatusModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="massReturnModal" tabindex="-1" role="dialog" aria-labelledby="massReturnModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="PrintLabelModal" tabindex="-1" role="dialog" aria-labelledby="PrintLabelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
