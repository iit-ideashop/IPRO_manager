      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand">IPRO Manager</h3>
          ...
          <div class="inner cover">
            ...
            <p class="lead">You must login with your IIT Google credentials to use the IPRO Manager app. Please login using your IIT credentials</p>
            <p class="lead">
              <a href="/authenticate" class="btn btn-lg btn-default">Try Again</a>
            </p>
          </div>
